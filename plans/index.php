                ...
                <main>
                    ...
                    <form class = "px-5 py-5" action="" method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="weight_goal_change" name="weight_goal_change">
                        </div>
                        ...
                        <div class="mb-3 form-check">
                        <label for="weigth_goal_end">End Date</label>
                            <input type="date" id="weigth_goal_end" name="weigth_goal_end" class="" value = "<?php echo $today; ?>">
                        </div>
